...
const Footer = () => (
  <footer className="nb-footer-wrapper">
    <div className="master-container">
      <div className="nb-container nb-footer-container">

        {/* Column 1: Brand & Tagline */}
        <div className="nb-footer-brand">
          <h2>NAB & Co.</h2>
          <p className="nb-footer-tagline">Where systems shape performance</p>

          {/* Social Icons Aligned with Brand */}
          <div className="nb-footer-social-row">
            <a href="https://www.linkedin.com/company/nab-co-consulting/" aria-label="LinkedIn" target='_blank'>
            ...
            <a href="https://www.instagram.com/nabco.tz?igsh=MTI0dmEwYzc2dHV3OQ==" aria-label="Instagram" target='_blank' rel="noreferrer">
            ...
            {/* <a href="#" aria-label="WhatsApp" target='_blank'>
             <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 1 1-7.6-10.6 8.38 8.38 0 0 1 3.8.9L21 3z"></path></svg>
           </a> */}
          </div>
        </div>
        ...
        {/* Column 2: Links */}
        <div>
          <h4 className="nb-footer-title">Quick links</h4>
          <ul className="nb-footer-links-grid">
        ...
        <div style={{ textAlign: 'inherit' }}>
          <h4 className="nb-footer-title">Get in touch</h4>
          <p style={{ color: '#ccc', marginBottom: '8px' }}>Dar es Salaam, Tanzania</p>
          <p style={{ color: 'var(--gold)', fontWeight: '700', marginBottom: '8px' }}>info@nabco.co.tz</p>
          <p style={{ color: 'white', fontWeight: 'bold' }}>+255 798 310 776</p>
        </div>
    ...
    {/* Bottom Copyright */}
    <div className="nb-container nb-footer-bottom-bar">
