    ...
    <div className="mv-container">
      <div className="master-container">
        <div className="header-spacing">
          ...
          <p className="mv-sub-header">
            Our work is shaped by our founder, Nyaeri Bwana, whose passion for organisational performance and data-driven decision-making guides how we work with clients.
          </p>
        </div>

        <div className="mv-mission-vision-grid">
          <div className="card-art">
            <h3>Our Mission</h3>
            <p>To help organisations achieve measurable performance improvement by diagnosing root causes, strengthening systems, and supporting better decision-making through evidence-based consulting, systems thinking, and AI-supported analysis where appropriate.</p>
          </div>
          <div className="card-art">
            <h3>Our Vision</h3>
            <p>To be a trusted management consulting firm in East Africa, recognised for delivering sustainable performance improvement and practical transformation.</p>
          </div>
        </div>
        ...
        <Swiper 
          ...
          className="mv-swiper-wrapper"
        >
          {values.map((v, i) => (
            <SwiperSlide key={i}>
              <div className="mv-slide-inner">
                <div className="card-art mv-value-card">
                  ...
                  <h3>{v.t}</h3>
                  <p className="mv-value-desc">{v.d}</p>
                </div>
              </div>
            </SwiperSlide>
          ))}
