  ...
  <div style={{ background: 'var(--black)', minHeight: '100vh', paddingBottom: '100px' }}>
    <div className="master-container">
      ...
      <div style={{ maxWidth: '900px' }}>
        ...
        <p>We focus on understanding how people, processes, data, and structures interact in real operating environments to identify root causes and design targeted, measurable, and sustainable improvements.</p>
